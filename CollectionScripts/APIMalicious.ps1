...
$APIFileName = "API_" + $Time + "_Malicious.json"
$APIFilePath = $ResultsFolder + $APIFileName
$APIAlertInfoFileName = "API_" + $Time + "_AlertInfo_Malicious.json"
$APIAlertInfoFilePath = $ResultsFolder + $APIAlertInfoFileName
$APIAlertEvidenceFileName = "API_" + $Time + "_AlertEvidence_Malicious.json"
